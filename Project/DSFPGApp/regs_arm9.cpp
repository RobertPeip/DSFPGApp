...
RegSect_display9::RegSect_display9()
{
    ...
    A_BG0CNT_Character_Base_Block = DSReg(0x0008, 3, 2, 1, 0, "readwrite", "A_BG0CNT_Character_Base_Block", Regs_Arm9.data);
    A_BG0CNT_UNUSED_4_5 = DSReg(0x0008, 5, 4, 1, 0, "readwrite", "A_BG0CNT_UNUSED_4_5", Regs_Arm9.data);
    ...
    A_BG1CNT_Character_Base_Block = DSReg(0x0008, 19, 18, 1, 0, "readwrite", "A_BG1CNT_Character_Base_Block", Regs_Arm9.data);
    A_BG1CNT_UNUSED_4_5 = DSReg(0x0008, 21, 20, 1, 0, "readwrite", "A_BG1CNT_UNUSED_4_5", Regs_Arm9.data);
    ...
    A_BG2CNT_Character_Base_Block = DSReg(0x000C, 3, 2, 1, 0, "readwrite", "A_BG2CNT_Character_Base_Block", Regs_Arm9.data);
    A_BG2CNT_UNUSED_4_5 = DSReg(0x000C, 5, 4, 1, 0, "readwrite", "A_BG2CNT_UNUSED_4_5", Regs_Arm9.data);
    ...
    A_BG3CNT_Character_Base_Block = DSReg(0x000C, 19, 18, 1, 0, "readwrite", "A_BG3CNT_Character_Base_Block", Regs_Arm9.data);
    A_BG3CNT_UNUSED_4_5 = DSReg(0x000C, 21, 20, 1, 0, "readwrite", "A_BG3CNT_UNUSED_4_5", Regs_Arm9.data);
    ...
    B_BG0CNT_Character_Base_Block = DSReg(0x1008, 3, 2, 1, 0, "readwrite", "B_BG0CNT_Character_Base_Block", Regs_Arm9.data);
    B_BG0CNT_UNUSED_4_5 = DSReg(0x1008, 5, 4, 1, 0, "readwrite", "B_BG0CNT_UNUSED_4_5", Regs_Arm9.data);
    ...
    B_BG1CNT_Character_Base_Block = DSReg(0x1008, 19, 18, 1, 0, "readwrite", "B_BG1CNT_Character_Base_Block", Regs_Arm9.data);
    B_BG1CNT_UNUSED_4_5 = DSReg(0x1008, 21, 20, 1, 0, "readwrite", "B_BG1CNT_UNUSED_4_5", Regs_Arm9.data);
    ...
    B_BG2CNT_Character_Base_Block = DSReg(0x100C, 3, 2, 1, 0, "readwrite", "B_BG2CNT_Character_Base_Block", Regs_Arm9.data);
    B_BG2CNT_UNUSED_4_5 = DSReg(0x100C, 5, 4, 1, 0, "readwrite", "B_BG2CNT_UNUSED_4_5", Regs_Arm9.data);
    ...
    B_BG3CNT_Character_Base_Block = DSReg(0x100C, 19, 18, 1, 0, "readwrite", "B_BG3CNT_Character_Base_Block", Regs_Arm9.data);
    B_BG3CNT_UNUSED_4_5 = DSReg(0x100C, 21, 20, 1, 0, "readwrite", "B_BG3CNT_UNUSED_4_5", Regs_Arm9.data);
...
void REGS_Arm9::reset()
{
      ...
      allregs[37] = Regs_Arm9.Sect_display9.A_BG0CNT_UNUSED_4_5;
      allregs[38] = Regs_Arm9.Sect_display9.A_BG0CNT_Mosaic;
      allregs[39] = Regs_Arm9.Sect_display9.A_BG0CNT_Colors_Palettes;
      allregs[40] = Regs_Arm9.Sect_display9.A_BG0CNT_Screen_Base_Block;
      ...
      allregs[45] = Regs_Arm9.Sect_display9.A_BG1CNT_UNUSED_4_5;
      allregs[46] = Regs_Arm9.Sect_display9.A_BG1CNT_Mosaic;
      allregs[47] = Regs_Arm9.Sect_display9.A_BG1CNT_Colors_Palettes;
      allregs[48] = Regs_Arm9.Sect_display9.A_BG1CNT_Screen_Base_Block;
      ...
      allregs[53] = Regs_Arm9.Sect_display9.A_BG2CNT_UNUSED_4_5;
      allregs[54] = Regs_Arm9.Sect_display9.A_BG2CNT_Mosaic;
      allregs[55] = Regs_Arm9.Sect_display9.A_BG2CNT_Colors_Palettes;
      allregs[56] = Regs_Arm9.Sect_display9.A_BG2CNT_Screen_Base_Block;
      allregs[57] = Regs_Arm9.Sect_display9.A_BG2CNT_Display_Area_Overflow;
      allregs[58] = Regs_Arm9.Sect_display9.A_BG2CNT_Screen_Size;
      allregs[59] = Regs_Arm9.Sect_display9.A_BG3CNT;
      allregs[60] = Regs_Arm9.Sect_display9.A_BG3CNT_BG_Priority;
      allregs[61] = Regs_Arm9.Sect_display9.A_BG3CNT_Character_Base_Block;
      allregs[62] = Regs_Arm9.Sect_display9.A_BG3CNT_UNUSED_4_5;
      allregs[63] = Regs_Arm9.Sect_display9.A_BG3CNT_Mosaic;
      allregs[64] = Regs_Arm9.Sect_display9.A_BG3CNT_Colors_Palettes;
      allregs[65] = Regs_Arm9.Sect_display9.A_BG3CNT_Screen_Base_Block;
      allregs[66] = Regs_Arm9.Sect_display9.A_BG3CNT_Display_Area_Overflow;
      allregs[67] = Regs_Arm9.Sect_display9.A_BG3CNT_Screen_Size;
      allregs[68] = Regs_Arm9.Sect_display9.A_BG0HOFS;
      allregs[69] = Regs_Arm9.Sect_display9.A_BG0VOFS;
      allregs[70] = Regs_Arm9.Sect_display9.A_BG1HOFS;
      allregs[71] = Regs_Arm9.Sect_display9.A_BG1VOFS;
      allregs[72] = Regs_Arm9.Sect_display9.A_BG2HOFS;
      allregs[73] = Regs_Arm9.Sect_display9.A_BG2VOFS;
      allregs[74] = Regs_Arm9.Sect_display9.A_BG3HOFS;
      allregs[75] = Regs_Arm9.Sect_display9.A_BG3VOFS;
      allregs[76] = Regs_Arm9.Sect_display9.A_BG2RotScaleParDX;
      allregs[77] = Regs_Arm9.Sect_display9.A_BG2RotScaleParDMX;
      allregs[78] = Regs_Arm9.Sect_display9.A_BG2RotScaleParDY;
      allregs[79] = Regs_Arm9.Sect_display9.A_BG2RotScaleParDMY;
      allregs[80] = Regs_Arm9.Sect_display9.A_BG2RefX;
      allregs[81] = Regs_Arm9.Sect_display9.A_BG2RefY;
      allregs[82] = Regs_Arm9.Sect_display9.A_BG3RotScaleParDX;
      allregs[83] = Regs_Arm9.Sect_display9.A_BG3RotScaleParDMX;
      allregs[84] = Regs_Arm9.Sect_display9.A_BG3RotScaleParDY;
      allregs[85] = Regs_Arm9.Sect_display9.A_BG3RotScaleParDMY;
      allregs[86] = Regs_Arm9.Sect_display9.A_BG3RefX;
      allregs[87] = Regs_Arm9.Sect_display9.A_BG3RefY;
      allregs[88] = Regs_Arm9.Sect_display9.A_WIN0H;
      allregs[89] = Regs_Arm9.Sect_display9.A_WIN0H_X2;
      allregs[90] = Regs_Arm9.Sect_display9.A_WIN0H_X1;
      allregs[91] = Regs_Arm9.Sect_display9.A_WIN1H;
      allregs[92] = Regs_Arm9.Sect_display9.A_WIN1H_X2;
      allregs[93] = Regs_Arm9.Sect_display9.A_WIN1H_X1;
      allregs[94] = Regs_Arm9.Sect_display9.A_WIN0V;
      allregs[95] = Regs_Arm9.Sect_display9.A_WIN0V_Y2;
      allregs[96] = Regs_Arm9.Sect_display9.A_WIN0V_Y1;
      allregs[97] = Regs_Arm9.Sect_display9.A_WIN1V;
      allregs[98] = Regs_Arm9.Sect_display9.A_WIN1V_Y2;
      allregs[99] = Regs_Arm9.Sect_display9.A_WIN1V_Y1;
      allregs[100] = Regs_Arm9.Sect_display9.A_WININ;
      allregs[101] = Regs_Arm9.Sect_display9.A_WININ_Window_0_BG0_Enable;
      allregs[102] = Regs_Arm9.Sect_display9.A_WININ_Window_0_BG1_Enable;
      allregs[103] = Regs_Arm9.Sect_display9.A_WININ_Window_0_BG2_Enable;
      allregs[104] = Regs_Arm9.Sect_display9.A_WININ_Window_0_BG3_Enable;
      allregs[105] = Regs_Arm9.Sect_display9.A_WININ_Window_0_OBJ_Enable;
      allregs[106] = Regs_Arm9.Sect_display9.A_WININ_Window_0_Special_Effect;
      allregs[107] = Regs_Arm9.Sect_display9.A_WININ_Window_1_BG0_Enable;
      allregs[108] = Regs_Arm9.Sect_display9.A_WININ_Window_1_BG1_Enable;
      allregs[109] = Regs_Arm9.Sect_display9.A_WININ_Window_1_BG2_Enable;
      allregs[110] = Regs_Arm9.Sect_display9.A_WININ_Window_1_BG3_Enable;
      allregs[111] = Regs_Arm9.Sect_display9.A_WININ_Window_1_OBJ_Enable;
      allregs[112] = Regs_Arm9.Sect_display9.A_WININ_Window_1_Special_Effect;
      allregs[113] = Regs_Arm9.Sect_display9.A_WINOUT;
      allregs[114] = Regs_Arm9.Sect_display9.A_WINOUT_Outside_BG0_Enable;
      allregs[115] = Regs_Arm9.Sect_display9.A_WINOUT_Outside_BG1_Enable;
      allregs[116] = Regs_Arm9.Sect_display9.A_WINOUT_Outside_BG2_Enable;
      allregs[117] = Regs_Arm9.Sect_display9.A_WINOUT_Outside_BG3_Enable;
      allregs[118] = Regs_Arm9.Sect_display9.A_WINOUT_Outside_OBJ_Enable;
      allregs[119] = Regs_Arm9.Sect_display9.A_WINOUT_Outside_Special_Effect;
      allregs[120] = Regs_Arm9.Sect_display9.A_WINOUT_Objwnd_BG0_Enable;
      allregs[121] = Regs_Arm9.Sect_display9.A_WINOUT_Objwnd_BG1_Enable;
      allregs[122] = Regs_Arm9.Sect_display9.A_WINOUT_Objwnd_BG2_Enable;
      allregs[123] = Regs_Arm9.Sect_display9.A_WINOUT_Objwnd_BG3_Enable;
      allregs[124] = Regs_Arm9.Sect_display9.A_WINOUT_Objwnd_OBJ_Enable;
      allregs[125] = Regs_Arm9.Sect_display9.A_WINOUT_Objwnd_Special_Effect;
      allregs[126] = Regs_Arm9.Sect_display9.A_MOSAIC;
      allregs[127] = Regs_Arm9.Sect_display9.A_MOSAIC_BG_Mosaic_H_Size;
      allregs[128] = Regs_Arm9.Sect_display9.A_MOSAIC_BG_Mosaic_V_Size;
      allregs[129] = Regs_Arm9.Sect_display9.A_MOSAIC_OBJ_Mosaic_H_Size;
      allregs[130] = Regs_Arm9.Sect_display9.A_MOSAIC_OBJ_Mosaic_V_Size;
      allregs[131] = Regs_Arm9.Sect_display9.A_BLDCNT;
      allregs[132] = Regs_Arm9.Sect_display9.A_BLDCNT_BG0_1st_Target_Pixel;
      allregs[133] = Regs_Arm9.Sect_display9.A_BLDCNT_BG1_1st_Target_Pixel;
      allregs[134] = Regs_Arm9.Sect_display9.A_BLDCNT_BG2_1st_Target_Pixel;
      allregs[135] = Regs_Arm9.Sect_display9.A_BLDCNT_BG3_1st_Target_Pixel;
      allregs[136] = Regs_Arm9.Sect_display9.A_BLDCNT_OBJ_1st_Target_Pixel;
      allregs[137] = Regs_Arm9.Sect_display9.A_BLDCNT_BD_1st_Target_Pixel;
      allregs[138] = Regs_Arm9.Sect_display9.A_BLDCNT_Color_Special_Effect;
      allregs[139] = Regs_Arm9.Sect_display9.A_BLDCNT_BG0_2nd_Target_Pixel;
      allregs[140] = Regs_Arm9.Sect_display9.A_BLDCNT_BG1_2nd_Target_Pixel;
      allregs[141] = Regs_Arm9.Sect_display9.A_BLDCNT_BG2_2nd_Target_Pixel;
      allregs[142] = Regs_Arm9.Sect_display9.A_BLDCNT_BG3_2nd_Target_Pixel;
      allregs[143] = Regs_Arm9.Sect_display9.A_BLDCNT_OBJ_2nd_Target_Pixel;
      allregs[144] = Regs_Arm9.Sect_display9.A_BLDCNT_BD_2nd_Target_Pixel;
      allregs[145] = Regs_Arm9.Sect_display9.A_BLDALPHA;
      allregs[146] = Regs_Arm9.Sect_display9.A_BLDALPHA_EVA_Coefficient;
      allregs[147] = Regs_Arm9.Sect_display9.A_BLDALPHA_EVB_Coefficient;
      allregs[148] = Regs_Arm9.Sect_display9.A_BLDY;
      allregs[149] = Regs_Arm9.Sect_display9.DISPCAPCNT;
      allregs[150] = Regs_Arm9.Sect_display9.DISPCAPCNT_EVA;
      allregs[151] = Regs_Arm9.Sect_display9.DISPCAPCNT_EVB;
      allregs[152] = Regs_Arm9.Sect_display9.DISPCAPCNT_VRAM_Write_Block;
      allregs[153] = Regs_Arm9.Sect_display9.DISPCAPCNT_VRAM_Write_Offset;
      allregs[154] = Regs_Arm9.Sect_display9.DISPCAPCNT_Capture_Size;
      allregs[155] = Regs_Arm9.Sect_display9.DISPCAPCNT_Source_A;
      allregs[156] = Regs_Arm9.Sect_display9.DISPCAPCNT_Source_B;
      allregs[157] = Regs_Arm9.Sect_display9.DISPCAPCNT_VRAM_Read_Offset;
      allregs[158] = Regs_Arm9.Sect_display9.DISPCAPCNT_Capture_Source;
      allregs[159] = Regs_Arm9.Sect_display9.DISPCAPCNT_Capture_Enable;
      allregs[160] = Regs_Arm9.Sect_display9.DISP_MMEM_FIFO;
      allregs[161] = Regs_Arm9.Sect_display9.A_MASTER_BRIGHT;
      allregs[162] = Regs_Arm9.Sect_display9.A_MASTER_BRIGHT_Factor;
      allregs[163] = Regs_Arm9.Sect_display9.A_MASTER_BRIGHT_Mode;
      allregs[164] = Regs_Arm9.Sect_display9.B_DISPCNT;
      allregs[165] = Regs_Arm9.Sect_display9.B_DISPCNT_BG_Mode;
      allregs[166] = Regs_Arm9.Sect_display9.B_DISPCNT_BG0_2D_3D;
      allregs[167] = Regs_Arm9.Sect_display9.B_DISPCNT_Tile_OBJ_Mapping;
      allregs[168] = Regs_Arm9.Sect_display9.B_DISPCNT_Bitmap_OBJ_2D_Dim;
      allregs[169] = Regs_Arm9.Sect_display9.B_DISPCNT_Bitmap_OBJ_Mapping;
      allregs[170] = Regs_Arm9.Sect_display9.B_DISPCNT_Forced_Blank;
      allregs[171] = Regs_Arm9.Sect_display9.B_DISPCNT_Screen_Display_BG0;
      allregs[172] = Regs_Arm9.Sect_display9.B_DISPCNT_Screen_Display_BG1;
      allregs[173] = Regs_Arm9.Sect_display9.B_DISPCNT_Screen_Display_BG2;
      allregs[174] = Regs_Arm9.Sect_display9.B_DISPCNT_Screen_Display_BG3;
      allregs[175] = Regs_Arm9.Sect_display9.B_DISPCNT_Screen_Display_OBJ;
      allregs[176] = Regs_Arm9.Sect_display9.B_DISPCNT_Window_0_Display_Flag;
      allregs[177] = Regs_Arm9.Sect_display9.B_DISPCNT_Window_1_Display_Flag;
      allregs[178] = Regs_Arm9.Sect_display9.B_DISPCNT_OBJ_Wnd_Display_Flag;
      allregs[179] = Regs_Arm9.Sect_display9.B_DISPCNT_Display_Mode;
      allregs[180] = Regs_Arm9.Sect_display9.B_DISPCNT_VRAM_block;
      allregs[181] = Regs_Arm9.Sect_display9.B_DISPCNT_Tile_OBJ_1D_Boundary;
      allregs[182] = Regs_Arm9.Sect_display9.B_DISPCNT_Bitmap_OBJ_1D_Boundary;
      allregs[183] = Regs_Arm9.Sect_display9.B_DISPCNT_OBJ_Process_H_Blank;
      allregs[184] = Regs_Arm9.Sect_display9.B_DISPCNT_Character_Base;
      allregs[185] = Regs_Arm9.Sect_display9.B_DISPCNT_Screen_Base;
      allregs[186] = Regs_Arm9.Sect_display9.B_DISPCNT_BG_Extended_Palettes;
      allregs[187] = Regs_Arm9.Sect_display9.B_DISPCNT_OBJ_Extended_Palettes;
      allregs[188] = Regs_Arm9.Sect_display9.B_BG0CNT;
      allregs[189] = Regs_Arm9.Sect_display9.B_BG0CNT_BG_Priority;
      allregs[190] = Regs_Arm9.Sect_display9.B_BG0CNT_Character_Base_Block;
      allregs[191] = Regs_Arm9.Sect_display9.B_BG0CNT_UNUSED_4_5;
      allregs[192] = Regs_Arm9.Sect_display9.B_BG0CNT_Mosaic;
      allregs[193] = Regs_Arm9.Sect_display9.B_BG0CNT_Colors_Palettes;
      allregs[194] = Regs_Arm9.Sect_display9.B_BG0CNT_Screen_Base_Block;
      allregs[195] = Regs_Arm9.Sect_display9.B_BG0CNT_Screen_Size;
      allregs[196] = Regs_Arm9.Sect_display9.B_BG1CNT;
      allregs[197] = Regs_Arm9.Sect_display9.B_BG1CNT_BG_Priority;
      allregs[198] = Regs_Arm9.Sect_display9.B_BG1CNT_Character_Base_Block;
      allregs[199] = Regs_Arm9.Sect_display9.B_BG1CNT_UNUSED_4_5;
      allregs[200] = Regs_Arm9.Sect_display9.B_BG1CNT_Mosaic;
      allregs[201] = Regs_Arm9.Sect_display9.B_BG1CNT_Colors_Palettes;
      allregs[202] = Regs_Arm9.Sect_display9.B_BG1CNT_Screen_Base_Block;
      allregs[203] = Regs_Arm9.Sect_display9.B_BG1CNT_Screen_Size;
      allregs[204] = Regs_Arm9.Sect_display9.B_BG2CNT;
      allregs[205] = Regs_Arm9.Sect_display9.B_BG2CNT_BG_Priority;
      allregs[206] = Regs_Arm9.Sect_display9.B_BG2CNT_Character_Base_Block;
      allregs[207] = Regs_Arm9.Sect_display9.B_BG2CNT_UNUSED_4_5;
      allregs[208] = Regs_Arm9.Sect_display9.B_BG2CNT_Mosaic;
      allregs[209] = Regs_Arm9.Sect_display9.B_BG2CNT_Colors_Palettes;
      allregs[210] = Regs_Arm9.Sect_display9.B_BG2CNT_Screen_Base_Block;
      allregs[211] = Regs_Arm9.Sect_display9.B_BG2CNT_Display_Area_Overflow;
      allregs[212] = Regs_Arm9.Sect_display9.B_BG2CNT_Screen_Size;
      allregs[213] = Regs_Arm9.Sect_display9.B_BG3CNT;
      allregs[214] = Regs_Arm9.Sect_display9.B_BG3CNT_BG_Priority;
      allregs[215] = Regs_Arm9.Sect_display9.B_BG3CNT_Character_Base_Block;
      allregs[216] = Regs_Arm9.Sect_display9.B_BG3CNT_UNUSED_4_5;
      allregs[217] = Regs_Arm9.Sect_display9.B_BG3CNT_Mosaic;
      allregs[218] = Regs_Arm9.Sect_display9.B_BG3CNT_Colors_Palettes;
      allregs[219] = Regs_Arm9.Sect_display9.B_BG3CNT_Screen_Base_Block;
      allregs[220] = Regs_Arm9.Sect_display9.B_BG3CNT_Display_Area_Overflow;
      allregs[221] = Regs_Arm9.Sect_display9.B_BG3CNT_Screen_Size;
      allregs[222] = Regs_Arm9.Sect_display9.B_BG0HOFS;
      allregs[223] = Regs_Arm9.Sect_display9.B_BG0VOFS;
      allregs[224] = Regs_Arm9.Sect_display9.B_BG1HOFS;
      allregs[225] = Regs_Arm9.Sect_display9.B_BG1VOFS;
      allregs[226] = Regs_Arm9.Sect_display9.B_BG2HOFS;
      allregs[227] = Regs_Arm9.Sect_display9.B_BG2VOFS;
      allregs[228] = Regs_Arm9.Sect_display9.B_BG3HOFS;
      allregs[229] = Regs_Arm9.Sect_display9.B_BG3VOFS;
      allregs[230] = Regs_Arm9.Sect_display9.B_BG2RotScaleParDX;
      allregs[231] = Regs_Arm9.Sect_display9.B_BG2RotScaleParDMX;
      allregs[232] = Regs_Arm9.Sect_display9.B_BG2RotScaleParDY;
      allregs[233] = Regs_Arm9.Sect_display9.B_BG2RotScaleParDMY;
      allregs[234] = Regs_Arm9.Sect_display9.B_BG2RefX;
      allregs[235] = Regs_Arm9.Sect_display9.B_BG2RefY;
      allregs[236] = Regs_Arm9.Sect_display9.B_BG3RotScaleParDX;
      allregs[237] = Regs_Arm9.Sect_display9.B_BG3RotScaleParDMX;
      allregs[238] = Regs_Arm9.Sect_display9.B_BG3RotScaleParDY;
      allregs[239] = Regs_Arm9.Sect_display9.B_BG3RotScaleParDMY;
      allregs[240] = Regs_Arm9.Sect_display9.B_BG3RefX;
      allregs[241] = Regs_Arm9.Sect_display9.B_BG3RefY;
      allregs[242] = Regs_Arm9.Sect_display9.B_WIN0H;
      allregs[243] = Regs_Arm9.Sect_display9.B_WIN0H_X2;
      allregs[244] = Regs_Arm9.Sect_display9.B_WIN0H_X1;
      allregs[245] = Regs_Arm9.Sect_display9.B_WIN1H;
      allregs[246] = Regs_Arm9.Sect_display9.B_WIN1H_X2;
      allregs[247] = Regs_Arm9.Sect_display9.B_WIN1H_X1;
      allregs[248] = Regs_Arm9.Sect_display9.B_WIN0V;
      allregs[249] = Regs_Arm9.Sect_display9.B_WIN0V_Y2;
      allregs[250] = Regs_Arm9.Sect_display9.B_WIN0V_Y1;
      allregs[251] = Regs_Arm9.Sect_display9.B_WIN1V;
      allregs[252] = Regs_Arm9.Sect_display9.B_WIN1V_Y2;
      allregs[253] = Regs_Arm9.Sect_display9.B_WIN1V_Y1;
      allregs[254] = Regs_Arm9.Sect_display9.B_WININ;
      allregs[255] = Regs_Arm9.Sect_display9.B_WININ_Window_0_BG0_Enable;
      allregs[256] = Regs_Arm9.Sect_display9.B_WININ_Window_0_BG1_Enable;
      allregs[257] = Regs_Arm9.Sect_display9.B_WININ_Window_0_BG2_Enable;
      allregs[258] = Regs_Arm9.Sect_display9.B_WININ_Window_0_BG3_Enable;
      allregs[259] = Regs_Arm9.Sect_display9.B_WININ_Window_0_OBJ_Enable;
      allregs[260] = Regs_Arm9.Sect_display9.B_WININ_Window_0_Special_Effect;
      allregs[261] = Regs_Arm9.Sect_display9.B_WININ_Window_1_BG0_Enable;
      allregs[262] = Regs_Arm9.Sect_display9.B_WININ_Window_1_BG1_Enable;
      allregs[263] = Regs_Arm9.Sect_display9.B_WININ_Window_1_BG2_Enable;
      allregs[264] = Regs_Arm9.Sect_display9.B_WININ_Window_1_BG3_Enable;
      allregs[265] = Regs_Arm9.Sect_display9.B_WININ_Window_1_OBJ_Enable;
      allregs[266] = Regs_Arm9.Sect_display9.B_WININ_Window_1_Special_Effect;
      allregs[267] = Regs_Arm9.Sect_display9.B_WINOUT;
      allregs[268] = Regs_Arm9.Sect_display9.B_WINOUT_Outside_BG0_Enable;
      allregs[269] = Regs_Arm9.Sect_display9.B_WINOUT_Outside_BG1_Enable;
      allregs[270] = Regs_Arm9.Sect_display9.B_WINOUT_Outside_BG2_Enable;
      allregs[271] = Regs_Arm9.Sect_display9.B_WINOUT_Outside_BG3_Enable;
      allregs[272] = Regs_Arm9.Sect_display9.B_WINOUT_Outside_OBJ_Enable;
      allregs[273] = Regs_Arm9.Sect_display9.B_WINOUT_Outside_Special_Effect;
      allregs[274] = Regs_Arm9.Sect_display9.B_WINOUT_Objwnd_BG0_Enable;
      allregs[275] = Regs_Arm9.Sect_display9.B_WINOUT_Objwnd_BG1_Enable;
      allregs[276] = Regs_Arm9.Sect_display9.B_WINOUT_Objwnd_BG2_Enable;
      allregs[277] = Regs_Arm9.Sect_display9.B_WINOUT_Objwnd_BG3_Enable;
      allregs[278] = Regs_Arm9.Sect_display9.B_WINOUT_Objwnd_OBJ_Enable;
      allregs[279] = Regs_Arm9.Sect_display9.B_WINOUT_Objwnd_Special_Effect;
      allregs[280] = Regs_Arm9.Sect_display9.B_MOSAIC;
      allregs[281] = Regs_Arm9.Sect_display9.B_MOSAIC_BG_Mosaic_H_Size;
      allregs[282] = Regs_Arm9.Sect_display9.B_MOSAIC_BG_Mosaic_V_Size;
      allregs[283] = Regs_Arm9.Sect_display9.B_MOSAIC_OBJ_Mosaic_H_Size;
      allregs[284] = Regs_Arm9.Sect_display9.B_MOSAIC_OBJ_Mosaic_V_Size;
      allregs[285] = Regs_Arm9.Sect_display9.B_BLDCNT;
      allregs[286] = Regs_Arm9.Sect_display9.B_BLDCNT_BG0_1st_Target_Pixel;
      allregs[287] = Regs_Arm9.Sect_display9.B_BLDCNT_BG1_1st_Target_Pixel;
      allregs[288] = Regs_Arm9.Sect_display9.B_BLDCNT_BG2_1st_Target_Pixel;
      allregs[289] = Regs_Arm9.Sect_display9.B_BLDCNT_BG3_1st_Target_Pixel;
      allregs[290] = Regs_Arm9.Sect_display9.B_BLDCNT_OBJ_1st_Target_Pixel;
      allregs[291] = Regs_Arm9.Sect_display9.B_BLDCNT_BD_1st_Target_Pixel;
      allregs[292] = Regs_Arm9.Sect_display9.B_BLDCNT_Color_Special_Effect;
      allregs[293] = Regs_Arm9.Sect_display9.B_BLDCNT_BG0_2nd_Target_Pixel;
      allregs[294] = Regs_Arm9.Sect_display9.B_BLDCNT_BG1_2nd_Target_Pixel;
      allregs[295] = Regs_Arm9.Sect_display9.B_BLDCNT_BG2_2nd_Target_Pixel;
      allregs[296] = Regs_Arm9.Sect_display9.B_BLDCNT_BG3_2nd_Target_Pixel;
      allregs[297] = Regs_Arm9.Sect_display9.B_BLDCNT_OBJ_2nd_Target_Pixel;
      allregs[298] = Regs_Arm9.Sect_display9.B_BLDCNT_BD_2nd_Target_Pixel;
      allregs[299] = Regs_Arm9.Sect_display9.B_BLDALPHA;
      allregs[300] = Regs_Arm9.Sect_display9.B_BLDALPHA_EVA_Coefficient;
      allregs[301] = Regs_Arm9.Sect_display9.B_BLDALPHA_EVB_Coefficient;
      allregs[302] = Regs_Arm9.Sect_display9.B_BLDY;
      allregs[303] = Regs_Arm9.Sect_display9.B_MASTER_BRIGHT;
      allregs[304] = Regs_Arm9.Sect_display9.B_MASTER_BRIGHT_Factor;
      allregs[305] = Regs_Arm9.Sect_display9.B_MASTER_BRIGHT_Mode;
      allregs[306] = Regs_Arm9.Sect_dma9.DMA0SAD;
      allregs[307] = Regs_Arm9.Sect_dma9.DMA0DAD;
      allregs[308] = Regs_Arm9.Sect_dma9.DMA0CNT_L;
      allregs[309] = Regs_Arm9.Sect_dma9.DMA0CNT_H;
      allregs[310] = Regs_Arm9.Sect_dma9.DMA0CNT_H_Dest_Addr_Control;
      allregs[311] = Regs_Arm9.Sect_dma9.DMA0CNT_H_Source_Adr_Control;
      allregs[312] = Regs_Arm9.Sect_dma9.DMA0CNT_H_DMA_Repeat;
      allregs[313] = Regs_Arm9.Sect_dma9.DMA0CNT_H_DMA_Transfer_Type;
      allregs[314] = Regs_Arm9.Sect_dma9.DMA0CNT_H_DMA_Start_Timing;
      allregs[315] = Regs_Arm9.Sect_dma9.DMA0CNT_H_IRQ_on;
      allregs[316] = Regs_Arm9.Sect_dma9.DMA0CNT_H_DMA_Enable;
      allregs[317] = Regs_Arm9.Sect_dma9.DMA1SAD;
      allregs[318] = Regs_Arm9.Sect_dma9.DMA1DAD;
      allregs[319] = Regs_Arm9.Sect_dma9.DMA1CNT_L;
      allregs[320] = Regs_Arm9.Sect_dma9.DMA1CNT_H;
      allregs[321] = Regs_Arm9.Sect_dma9.DMA1CNT_H_Dest_Addr_Control;
      allregs[322] = Regs_Arm9.Sect_dma9.DMA1CNT_H_Source_Adr_Control;
      allregs[323] = Regs_Arm9.Sect_dma9.DMA1CNT_H_DMA_Repeat;
      allregs[324] = Regs_Arm9.Sect_dma9.DMA1CNT_H_DMA_Transfer_Type;
      allregs[325] = Regs_Arm9.Sect_dma9.DMA1CNT_H_DMA_Start_Timing;
      allregs[326] = Regs_Arm9.Sect_dma9.DMA1CNT_H_IRQ_on;
      allregs[327] = Regs_Arm9.Sect_dma9.DMA1CNT_H_DMA_Enable;
      allregs[328] = Regs_Arm9.Sect_dma9.DMA2SAD;
      allregs[329] = Regs_Arm9.Sect_dma9.DMA2DAD;
      allregs[330] = Regs_Arm9.Sect_dma9.DMA2CNT_L;
      allregs[331] = Regs_Arm9.Sect_dma9.DMA2CNT_H;
      allregs[332] = Regs_Arm9.Sect_dma9.DMA2CNT_H_Dest_Addr_Control;
      allregs[333] = Regs_Arm9.Sect_dma9.DMA2CNT_H_Source_Adr_Control;
      allregs[334] = Regs_Arm9.Sect_dma9.DMA2CNT_H_DMA_Repeat;
      allregs[335] = Regs_Arm9.Sect_dma9.DMA2CNT_H_DMA_Transfer_Type;
      allregs[336] = Regs_Arm9.Sect_dma9.DMA2CNT_H_DMA_Start_Timing;
      allregs[337] = Regs_Arm9.Sect_dma9.DMA2CNT_H_IRQ_on;
      allregs[338] = Regs_Arm9.Sect_dma9.DMA2CNT_H_DMA_Enable;
      allregs[339] = Regs_Arm9.Sect_dma9.DMA3SAD;
      allregs[340] = Regs_Arm9.Sect_dma9.DMA3DAD;
      allregs[341] = Regs_Arm9.Sect_dma9.DMA3CNT_L;
      allregs[342] = Regs_Arm9.Sect_dma9.DMA3CNT_H;
      allregs[343] = Regs_Arm9.Sect_dma9.DMA3CNT_H_Dest_Addr_Control;
      allregs[344] = Regs_Arm9.Sect_dma9.DMA3CNT_H_Source_Adr_Control;
      allregs[345] = Regs_Arm9.Sect_dma9.DMA3CNT_H_DMA_Repeat;
      allregs[346] = Regs_Arm9.Sect_dma9.DMA3CNT_H_DMA_Transfer_Type;
      allregs[347] = Regs_Arm9.Sect_dma9.DMA3CNT_H_Game_Pak_DRQ;
      allregs[348] = Regs_Arm9.Sect_dma9.DMA3CNT_H_DMA_Start_Timing;
      allregs[349] = Regs_Arm9.Sect_dma9.DMA3CNT_H_IRQ_on;
      allregs[350] = Regs_Arm9.Sect_dma9.DMA3CNT_H_DMA_Enable;
      allregs[351] = Regs_Arm9.Sect_dma9.DMA0FILL;
      allregs[352] = Regs_Arm9.Sect_dma9.DMA1FILL;
      allregs[353] = Regs_Arm9.Sect_dma9.DMA2FILL;
      allregs[354] = Regs_Arm9.Sect_dma9.DMA3FILL;
      allregs[355] = Regs_Arm9.Sect_timer9.TM0CNT_L;
      allregs[356] = Regs_Arm9.Sect_timer9.TM0CNT_H;
      allregs[357] = Regs_Arm9.Sect_timer9.TM0CNT_H_Prescaler;
      allregs[358] = Regs_Arm9.Sect_timer9.TM0CNT_H_Count_up;
      allregs[359] = Regs_Arm9.Sect_timer9.TM0CNT_H_Timer_IRQ_Enable;
      allregs[360] = Regs_Arm9.Sect_timer9.TM0CNT_H_Timer_Start_Stop;
      allregs[361] = Regs_Arm9.Sect_timer9.TM1CNT_L;
      allregs[362] = Regs_Arm9.Sect_timer9.TM1CNT_H;
      allregs[363] = Regs_Arm9.Sect_timer9.TM1CNT_H_Prescaler;
      allregs[364] = Regs_Arm9.Sect_timer9.TM1CNT_H_Count_up;
      allregs[365] = Regs_Arm9.Sect_timer9.TM1CNT_H_Timer_IRQ_Enable;
      allregs[366] = Regs_Arm9.Sect_timer9.TM1CNT_H_Timer_Start_Stop;
      allregs[367] = Regs_Arm9.Sect_timer9.TM2CNT_L;
      allregs[368] = Regs_Arm9.Sect_timer9.TM2CNT_H;
      allregs[369] = Regs_Arm9.Sect_timer9.TM2CNT_H_Prescaler;
      allregs[370] = Regs_Arm9.Sect_timer9.TM2CNT_H_Count_up;
      allregs[371] = Regs_Arm9.Sect_timer9.TM2CNT_H_Timer_IRQ_Enable;
      allregs[372] = Regs_Arm9.Sect_timer9.TM2CNT_H_Timer_Start_Stop;
      allregs[373] = Regs_Arm9.Sect_timer9.TM3CNT_L;
      allregs[374] = Regs_Arm9.Sect_timer9.TM3CNT_H;
      allregs[375] = Regs_Arm9.Sect_timer9.TM3CNT_H_Prescaler;
      allregs[376] = Regs_Arm9.Sect_timer9.TM3CNT_H_Count_up;
      allregs[377] = Regs_Arm9.Sect_timer9.TM3CNT_H_Timer_IRQ_Enable;
      allregs[378] = Regs_Arm9.Sect_timer9.TM3CNT_H_Timer_Start_Stop;
      allregs[379] = Regs_Arm9.Sect_keypad9.KEYINPUT;
      allregs[380] = Regs_Arm9.Sect_keypad9.KEYCNT;
      allregs[381] = Regs_Arm9.Sect_system9.IPCSYNC;
      allregs[382] = Regs_Arm9.Sect_system9.IPCSYNC_Data_from_IPCSYNC;
      allregs[383] = Regs_Arm9.Sect_system9.IPCSYNC_Data_to_IPCSYNC;
      allregs[384] = Regs_Arm9.Sect_system9.IPCSYNC_IRQ;
      allregs[385] = Regs_Arm9.Sect_system9.IPCSYNC_Ena_IRQ_from_remote_CPU;
      allregs[386] = Regs_Arm9.Sect_system9.IPCFIFOCNT;
      allregs[387] = Regs_Arm9.Sect_system9.IPCFIFOCNT_Send_Fifo_Empty_Status;
      allregs[388] = Regs_Arm9.Sect_system9.IPCFIFOCNT_Send_Fifo_Full_Status;
      allregs[389] = Regs_Arm9.Sect_system9.IPCFIFOCNT_Send_Fifo_Empty_IRQ;
      allregs[390] = Regs_Arm9.Sect_system9.IPCFIFOCNT_Send_Fifo_Clear;
      allregs[391] = Regs_Arm9.Sect_system9.IPCFIFOCNT_Receive_Fifo_Empty;
      allregs[392] = Regs_Arm9.Sect_system9.IPCFIFOCNT_Receive_Fifo_Full;
      allregs[393] = Regs_Arm9.Sect_system9.IPCFIFOCNT_Receive_Fifo_Not_Empty_IRQ;
      allregs[394] = Regs_Arm9.Sect_system9.IPCFIFOCNT_Error_Read_Empty_Send_Full;
      allregs[395] = Regs_Arm9.Sect_system9.IPCFIFOCNT_Enable_Send_Receive_Fifo;
      allregs[396] = Regs_Arm9.Sect_system9.IPCFIFOSEND;
      allregs[397] = Regs_Arm9.Sect_system9.IPCFIFORECV;
      allregs[398] = Regs_Arm9.Sect_system9.AUXSPICNT;
      allregs[399] = Regs_Arm9.Sect_system9.AUXSPICNT_SPI_Baudrate;
      allregs[400] = Regs_Arm9.Sect_system9.AUXSPICNT_SPI_Hold_Chipselect;
      allregs[401] = Regs_Arm9.Sect_system9.AUXSPICNT_SPI_Busy;
      allregs[402] = Regs_Arm9.Sect_system9.AUXSPICNT_NDS_Slot_Mode;
      allregs[403] = Regs_Arm9.Sect_system9.AUXSPICNT_Transfer_Ready_IRQ;
      allregs[404] = Regs_Arm9.Sect_system9.AUXSPICNT_NDS_Slot_Enable;
      allregs[405] = Regs_Arm9.Sect_system9.AUXSPIDATA;
      allregs[406] = Regs_Arm9.Sect_system9.ROMCTRL;
      allregs[407] = Regs_Arm9.Sect_system9.ROMCTRL_KEY1_gap1_length;
      allregs[408] = Regs_Arm9.Sect_system9.ROMCTRL_KEY2_encrypt_data;
      allregs[409] = Regs_Arm9.Sect_system9.ROMCTRL_SE;
      allregs[410] = Regs_Arm9.Sect_system9.ROMCTRL_KEY2_Apply_Seed;
      allregs[411] = Regs_Arm9.Sect_system9.ROMCTRL_KEY1_gap2_length;
      allregs[412] = Regs_Arm9.Sect_system9.ROMCTRL_KEY2_encrypt_cmd;
      allregs[413] = Regs_Arm9.Sect_system9.ROMCTRL_Data_Word_Status;
      allregs[414] = Regs_Arm9.Sect_system9.ROMCTRL_Data_Block_size;
      allregs[415] = Regs_Arm9.Sect_system9.ROMCTRL_Transfer_CLK_rate;
      allregs[416] = Regs_Arm9.Sect_system9.ROMCTRL_KEY1_Gap_CLKs;
      allregs[417] = Regs_Arm9.Sect_system9.ROMCTRL_RESB_Release_Reset;
      allregs[418] = Regs_Arm9.Sect_system9.ROMCTRL_WR;
      allregs[419] = Regs_Arm9.Sect_system9.ROMCTRL_Block_Start_Status;
      allregs[420] = Regs_Arm9.Sect_system9.Gamecard_bus_Command_1;
      allregs[421] = Regs_Arm9.Sect_system9.Gamecard_bus_Command_2;
      allregs[422] = Regs_Arm9.Sect_system9.Gamecard_bus_DataIn;
      allregs[423] = Regs_Arm9.Sect_system9.Encryption_Seed_0_Lower;
      allregs[424] = Regs_Arm9.Sect_system9.Encryption_Seed_1_Lower;
      allregs[425] = Regs_Arm9.Sect_system9.Encryption_Seed_0_Upper;
      allregs[426] = Regs_Arm9.Sect_system9.Encryption_Seed_1_Upper;
      allregs[427] = Regs_Arm9.Sect_system9.EXMEMCNT;
      allregs[428] = Regs_Arm9.Sect_system9.EXMEMCNT_GBASlot_SRAM_Access_Time;
      allregs[429] = Regs_Arm9.Sect_system9.EXMEMCNT_GBASlot_ROM_1st_Access_Time;
      allregs[430] = Regs_Arm9.Sect_system9.EXMEMCNT_GBASlot_ROM_2nd_Access_Time;
      allregs[431] = Regs_Arm9.Sect_system9.EXMEMCNT_GBASlot_PHI_pin_out;
      allregs[432] = Regs_Arm9.Sect_system9.EXMEMCNT_GBASlot_Access_Rights;
      allregs[433] = Regs_Arm9.Sect_system9.EXMEMCNT_NDSSlot_Access_Rights;
      allregs[434] = Regs_Arm9.Sect_system9.EXMEMCNT_SET;
      allregs[435] = Regs_Arm9.Sect_system9.EXMEMCNT_MainMem_Interface_Mode;
      allregs[436] = Regs_Arm9.Sect_system9.EXMEMCNT_MainMem_Access_Priority;
      allregs[437] = Regs_Arm9.Sect_system9.IME;
      allregs[438] = Regs_Arm9.Sect_system9.IE;
      allregs[439] = Regs_Arm9.Sect_system9.IE_LCD_V_Blank;
      allregs[440] = Regs_Arm9.Sect_system9.IE_LCD_H_Blank;
      allregs[441] = Regs_Arm9.Sect_system9.IE_LCD_V_Counter_Match;
      allregs[442] = Regs_Arm9.Sect_system9.IE_Timer_0;
      allregs[443] = Regs_Arm9.Sect_system9.IE_Timer_1;
      allregs[444] = Regs_Arm9.Sect_system9.IE_Timer_2;
      allregs[445] = Regs_Arm9.Sect_system9.IE_Timer_3;
      allregs[446] = Regs_Arm9.Sect_system9.IE_DMA_0;
      allregs[447] = Regs_Arm9.Sect_system9.IE_DMA_1;
      allregs[448] = Regs_Arm9.Sect_system9.IE_DMA_2;
      allregs[449] = Regs_Arm9.Sect_system9.IE_DMA_3;
      allregs[450] = Regs_Arm9.Sect_system9.IE_Keypad;
      allregs[451] = Regs_Arm9.Sect_system9.IE_GBA_Slot_external_IRQ;
      allregs[452] = Regs_Arm9.Sect_system9.IE_IPC_Sync;
      allregs[453] = Regs_Arm9.Sect_system9.IE_IPC_Send_FIFO_Empty;
      allregs[454] = Regs_Arm9.Sect_system9.IE_IPC_Recv_FIFO_Not_Empty;
      allregs[455] = Regs_Arm9.Sect_system9.IE_NDS_Slot_Transfer_Complete;
      allregs[456] = Regs_Arm9.Sect_system9.IE_NDS_Slot_IREQ_MC;
      allregs[457] = Regs_Arm9.Sect_system9.IE_Geometry_Command_FIFO;
      allregs[458] = Regs_Arm9.Sect_system9.IE_unused;
      allregs[459] = Regs_Arm9.Sect_system9.IF;
      allregs[460] = Regs_Arm9.Sect_system9.IF_LCD_V_Blank;
      allregs[461] = Regs_Arm9.Sect_system9.IF_LCD_H_Blank;
      allregs[462] = Regs_Arm9.Sect_system9.IF_LCD_V_Counter_Match;
      allregs[463] = Regs_Arm9.Sect_system9.IF_Timer_0;
      allregs[464] = Regs_Arm9.Sect_system9.IF_Timer_1;
      allregs[465] = Regs_Arm9.Sect_system9.IF_Timer_2;
      allregs[466] = Regs_Arm9.Sect_system9.IF_Timer_3;
      allregs[467] = Regs_Arm9.Sect_system9.IF_DMA_0;
      allregs[468] = Regs_Arm9.Sect_system9.IF_DMA_1;
      allregs[469] = Regs_Arm9.Sect_system9.IF_DMA_2;
      allregs[470] = Regs_Arm9.Sect_system9.IF_DMA_3;
      allregs[471] = Regs_Arm9.Sect_system9.IF_Keypad;
      allregs[472] = Regs_Arm9.Sect_system9.IF_GBA_Slot_external_IRQ;
      allregs[473] = Regs_Arm9.Sect_system9.IF_IPC_Sync;
      allregs[474] = Regs_Arm9.Sect_system9.IF_IPC_Send_FIFO_Empty;
      allregs[475] = Regs_Arm9.Sect_system9.IF_IPC_Recv_FIFO_Not_Empty;
      allregs[476] = Regs_Arm9.Sect_system9.IF_NDS_Slot_Transfer_Complete;
      allregs[477] = Regs_Arm9.Sect_system9.IF_NDS_Slot_IREQ_MC;
      allregs[478] = Regs_Arm9.Sect_system9.IF_Geometry_Command_FIFO;
      allregs[479] = Regs_Arm9.Sect_system9.MemControl1;
      allregs[480] = Regs_Arm9.Sect_system9.MemControl1_VRAM_A_MST;
      allregs[481] = Regs_Arm9.Sect_system9.MemControl1_VRAM_A_Offset;
      allregs[482] = Regs_Arm9.Sect_system9.MemControl1_VRAM_A_Enable;
      allregs[483] = Regs_Arm9.Sect_system9.MemControl1_VRAM_B_MST;
      allregs[484] = Regs_Arm9.Sect_system9.MemControl1_VRAM_B_Offset;
      allregs[485] = Regs_Arm9.Sect_system9.MemControl1_VRAM_B_Enable;
      allregs[486] = Regs_Arm9.Sect_system9.MemControl1_VRAM_C_MST;
      allregs[487] = Regs_Arm9.Sect_system9.MemControl1_VRAM_C_Offset;
      allregs[488] = Regs_Arm9.Sect_system9.MemControl1_VRAM_C_Enable;
      allregs[489] = Regs_Arm9.Sect_system9.MemControl1_VRAM_D_MST;
      allregs[490] = Regs_Arm9.Sect_system9.MemControl1_VRAM_D_Offset;
      allregs[491] = Regs_Arm9.Sect_system9.MemControl1_VRAM_D_Enable;
      allregs[492] = Regs_Arm9.Sect_system9.MemControl2;
      allregs[493] = Regs_Arm9.Sect_system9.MemControl2_VRAM_E_MST;
      allregs[494] = Regs_Arm9.Sect_system9.MemControl2_VRAM_E_Offset;
      allregs[495] = Regs_Arm9.Sect_system9.MemControl2_VRAM_E_Enable;
      allregs[496] = Regs_Arm9.Sect_system9.MemControl2_VRAM_F_MST;
      allregs[497] = Regs_Arm9.Sect_system9.MemControl2_VRAM_F_Offset;
      allregs[498] = Regs_Arm9.Sect_system9.MemControl2_VRAM_F_Enable;
      allregs[499] = Regs_Arm9.Sect_system9.MemControl2_VRAM_G_MST;
      allregs[500] = Regs_Arm9.Sect_system9.MemControl2_VRAM_G_Offset;
      allregs[501] = Regs_Arm9.Sect_system9.MemControl2_VRAM_G_Enable;
      allregs[502] = Regs_Arm9.Sect_system9.MemControl2_WRAM;
      allregs[503] = Regs_Arm9.Sect_system9.MemControl3;
      allregs[504] = Regs_Arm9.Sect_system9.MemControl3_VRAM_H_MST;
      allregs[505] = Regs_Arm9.Sect_system9.MemControl3_VRAM_H_Offset;
      allregs[506] = Regs_Arm9.Sect_system9.MemControl3_VRAM_H_Enable;
      allregs[507] = Regs_Arm9.Sect_system9.MemControl3_VRAM_I_MST;
      allregs[508] = Regs_Arm9.Sect_system9.MemControl3_VRAM_I_Offset;
      allregs[509] = Regs_Arm9.Sect_system9.MemControl3_VRAM_I_Enable;
      allregs[510] = Regs_Arm9.Sect_system9.DIVCNT;
      allregs[511] = Regs_Arm9.Sect_system9.DIVCNT_Division_Mode;
      allregs[512] = Regs_Arm9.Sect_system9.DIVCNT_Division_by_zero;
      allregs[513] = Regs_Arm9.Sect_system9.DIVCNT_Busy;
      allregs[514] = Regs_Arm9.Sect_system9.DIV_NUMER_Low;
      allregs[515] = Regs_Arm9.Sect_system9.DIV_NUMER_High;
      allregs[516] = Regs_Arm9.Sect_system9.DIV_DENOM_Low;
      allregs[517] = Regs_Arm9.Sect_system9.DIV_DENOM_High;
      allregs[518] = Regs_Arm9.Sect_system9.DIV_RESULT_Low;
      allregs[519] = Regs_Arm9.Sect_system9.DIV_RESULT_High;
      allregs[520] = Regs_Arm9.Sect_system9.DIVREM_RESULT_Low;
      allregs[521] = Regs_Arm9.Sect_system9.DIVREM_RESULT_High;
      allregs[522] = Regs_Arm9.Sect_system9.SQRTCN;
      allregs[523] = Regs_Arm9.Sect_system9.SQRTCN_Mode;
      allregs[524] = Regs_Arm9.Sect_system9.SQRTCN_Busy;
      allregs[525] = Regs_Arm9.Sect_system9.SQRT_RESULT;
      allregs[526] = Regs_Arm9.Sect_system9.SQRT_PARAM_Low;
      allregs[527] = Regs_Arm9.Sect_system9.SQRT_PARAM_High;
      allregs[528] = Regs_Arm9.Sect_system9.POSTFLG;
      allregs[529] = Regs_Arm9.Sect_system9.POSTFLG_Flag;
      allregs[530] = Regs_Arm9.Sect_system9.POSTFLG_RW;
      allregs[531] = Regs_Arm9.Sect_system9.POWCNT1;
      allregs[532] = Regs_Arm9.Sect_system9.POWCNT1_Enable_Flag_for_both_LCDs;
      allregs[533] = Regs_Arm9.Sect_system9.POWCNT1_2D_Graphics_Engine_A;
      allregs[534] = Regs_Arm9.Sect_system9.POWCNT1_3D_Rendering_Engine;
      allregs[535] = Regs_Arm9.Sect_system9.POWCNT1_3D_Geometry_Engine;
      allregs[536] = Regs_Arm9.Sect_system9.POWCNT1_2D_Graphics_Engine_B;
      allregs[537] = Regs_Arm9.Sect_system9.POWCNT1_Display_Swap;
    ...
    // A_BG0CNT at 0x0008 = 0xDFFFDFFF;
    rwmask[8] = (byte)(0xDFFFDFFF & 0xFF);
    rwmask[9] = (byte)((0xDFFFDFFF >> 8) & 0xFF);
    rwmask[10] = (byte)((0xDFFFDFFF >> 16) & 0xFF);
    rwmask[11] = (byte)((0xDFFFDFFF >> 24) & 0xFF);
    ...
    // B_BG0CNT at 0x1008 = 0xDFFFDFFF;
    rwmask[4104] = (byte)(0xDFFFDFFF & 0xFF);
    rwmask[4105] = (byte)((0xDFFFDFFF >> 8) & 0xFF);
    rwmask[4106] = (byte)((0xDFFFDFFF >> 16) & 0xFF);
    rwmask[4107] = (byte)((0xDFFFDFFF >> 24) & 0xFF);
