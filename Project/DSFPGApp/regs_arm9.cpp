...
RegSect_system9::RegSect_system9()
{
    ...
    MemControl1_VRAM_A_MST = DSReg(0x240, 1, 0, 1, 0, "readwrite", "MemControl1_VRAM_A_MST", Regs_Arm9.data);
    MemControl1_VRAM_A_Offset = DSReg(0x240, 4, 3, 1, 0, "readwrite", "MemControl1_VRAM_A_Offset", Regs_Arm9.data);
    MemControl1_VRAM_A_Enable = DSReg(0x240, 7, 7, 1, 0, "readwrite", "MemControl1_VRAM_A_Enable", Regs_Arm9.data);
    MemControl1_VRAM_B_MST = DSReg(0x240, 9, 8, 1, 0, "readwrite", "MemControl1_VRAM_B_MST", Regs_Arm9.data);
    MemControl1_VRAM_B_Offset = DSReg(0x240, 12, 11, 1, 0, "readwrite", "MemControl1_VRAM_B_Offset", Regs_Arm9.data);
    MemControl1_VRAM_B_Enable = DSReg(0x240, 15, 15, 1, 0, "readwrite", "MemControl1_VRAM_B_Enable", Regs_Arm9.data);
    MemControl1_VRAM_C_MST = DSReg(0x240, 18, 16, 1, 0, "readwrite", "MemControl1_VRAM_C_MST", Regs_Arm9.data);
    MemControl1_VRAM_C_Offset = DSReg(0x240, 20, 19, 1, 0, "readwrite", "MemControl1_VRAM_C_Offset", Regs_Arm9.data);
    MemControl1_VRAM_C_Enable = DSReg(0x240, 23, 23, 1, 0, "readwrite", "MemControl1_VRAM_C_Enable", Regs_Arm9.data);
    MemControl1_VRAM_D_MST = DSReg(0x240, 26, 24, 1, 0, "readwrite", "MemControl1_VRAM_D_MST", Regs_Arm9.data);
    MemControl1_VRAM_D_Offset = DSReg(0x240, 28, 27, 1, 0, "readwrite", "MemControl1_VRAM_D_Offset", Regs_Arm9.data);
    MemControl1_VRAM_D_Enable = DSReg(0x240, 31, 31, 1, 0, "readwrite", "MemControl1_VRAM_D_Enable", Regs_Arm9.data);
    MemControl2 = DSReg(0x244, 25, 0, 1, 0, "writeonly", "MemControl2", Regs_Arm9.data);
    MemControl2_VRAM_E_MST = DSReg(0x244, 2, 0, 1, 0, "readwrite", "MemControl2_VRAM_E_MST", Regs_Arm9.data);
    MemControl2_VRAM_E_Offset = DSReg(0x244, 4, 3, 1, 0, "readwrite", "MemControl2_VRAM_E_Offset", Regs_Arm9.data);
    MemControl2_VRAM_E_Enable = DSReg(0x244, 7, 7, 1, 0, "readwrite", "MemControl2_VRAM_E_Enable", Regs_Arm9.data);
    MemControl2_VRAM_F_MST = DSReg(0x244, 10, 8, 1, 0, "readwrite", "MemControl2_VRAM_F_MST", Regs_Arm9.data);
    MemControl2_VRAM_F_Offset = DSReg(0x244, 12, 11, 1, 0, "readwrite", "MemControl2_VRAM_F_Offset", Regs_Arm9.data);
    MemControl2_VRAM_F_Enable = DSReg(0x244, 15, 15, 1, 0, "readwrite", "MemControl2_VRAM_F_Enable", Regs_Arm9.data);
    MemControl2_VRAM_G_MST = DSReg(0x244, 18, 16, 1, 0, "readwrite", "MemControl2_VRAM_G_MST", Regs_Arm9.data);
    MemControl2_VRAM_G_Offset = DSReg(0x244, 20, 19, 1, 0, "readwrite", "MemControl2_VRAM_G_Offset", Regs_Arm9.data);
    MemControl2_VRAM_G_Enable = DSReg(0x244, 23, 23, 1, 0, "readwrite", "MemControl2_VRAM_G_Enable", Regs_Arm9.data);
    ...
    MemControl3_VRAM_H_MST = DSReg(0x248, 1, 0, 1, 0, "readwrite", "MemControl3_VRAM_H_MST", Regs_Arm9.data);
    MemControl3_VRAM_H_Offset = DSReg(0x248, 4, 3, 1, 0, "readwrite", "MemControl3_VRAM_H_Offset", Regs_Arm9.data);
    MemControl3_VRAM_H_Enable = DSReg(0x248, 7, 7, 1, 0, "readwrite", "MemControl3_VRAM_H_Enable", Regs_Arm9.data);
    MemControl3_VRAM_I_MST = DSReg(0x248, 9, 8, 1, 0, "readwrite", "MemControl3_VRAM_I_MST", Regs_Arm9.data);
    MemControl3_VRAM_I_Offset = DSReg(0x248, 12, 11, 1, 0, "readwrite", "MemControl3_VRAM_I_Offset", Regs_Arm9.data);
    MemControl3_VRAM_I_Enable = DSReg(0x248, 15, 15, 1, 0, "readwrite", "MemControl3_VRAM_I_Enable", Regs_Arm9.data);
...
void REGS_Arm9::reset()
{
    ...
    // MemControl1 at 0x240 = 0x9F9F9B9B;
    rwmask[576] = (byte)(0x9F9F9B9B & 0xFF);
    rwmask[577] = (byte)((0x9F9F9B9B >> 8) & 0xFF);
    rwmask[578] = (byte)((0x9F9F9B9B >> 16) & 0xFF);
    rwmask[579] = (byte)((0x9F9F9B9B >> 24) & 0xFF);
    // MemControl2 at 0x244 = 0x39F9F9F;
    rwmask[580] = (byte)(0x39F9F9F & 0xFF);
    rwmask[581] = (byte)((0x39F9F9F >> 8) & 0xFF);
    rwmask[582] = (byte)((0x39F9F9F >> 16) & 0xFF);
    rwmask[583] = (byte)((0x39F9F9F >> 24) & 0xFF);
    // MemControl3 at 0x248 = 0x9B9B;
    rwmask[584] = (byte)(0x9B9B & 0xFF);
    rwmask[585] = (byte)((0x9B9B >> 8) & 0xFF);
    rwmask[586] = (byte)((0x9B9B >> 16) & 0xFF);
    rwmask[587] = (byte)((0x9B9B >> 24) & 0xFF);
