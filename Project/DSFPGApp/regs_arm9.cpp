...
RegSect_system9::RegSect_system9()
{
    ...
    MemControl2_VRAM_E_MST = DSReg(0x244, 2, 0, 1, 0, "writeonly", Regs_Arm9.data);
    MemControl2_VRAM_E_Offset = DSReg(0x244, 4, 3, 1, 0, "writeonly", Regs_Arm9.data);
    MemControl2_VRAM_E_Enable = DSReg(0x244, 7, 7, 1, 0, "writeonly", Regs_Arm9.data);
    MemControl2_VRAM_F_MST = DSReg(0x244, 10, 8, 1, 0, "writeonly", Regs_Arm9.data);
    MemControl2_VRAM_F_Offset = DSReg(0x244, 12, 11, 1, 0, "writeonly", Regs_Arm9.data);
    MemControl2_VRAM_F_Enable = DSReg(0x244, 15, 15, 1, 0, "writeonly", Regs_Arm9.data);
    MemControl2_VRAM_G_MST = DSReg(0x244, 18, 16, 1, 0, "writeonly", Regs_Arm9.data);
    MemControl2_VRAM_G_Offset = DSReg(0x244, 20, 19, 1, 0, "writeonly", Regs_Arm9.data);
    MemControl2_VRAM_G_Enable = DSReg(0x244, 23, 23, 1, 0, "writeonly", Regs_Arm9.data);
    MemControl2_WRAM = DSReg(0x244, 25, 24, 1, 3, "readwrite", Regs_Arm9.data);
    MemControl3 = DSReg(0x248, 15, 0, 1, 0, "writeonly", Regs_Arm9.data);
    MemControl3_VRAM_H_MST = DSReg(0x248, 1, 0, 1, 0, "writeonly", Regs_Arm9.data);
    MemControl3_VRAM_H_Offset = DSReg(0x248, 4, 3, 1, 0, "writeonly", Regs_Arm9.data);
    MemControl3_VRAM_H_Enable = DSReg(0x248, 7, 7, 1, 0, "writeonly", Regs_Arm9.data);
    MemControl3_VRAM_I_MST = DSReg(0x248, 9, 8, 1, 0, "writeonly", Regs_Arm9.data);
    MemControl3_VRAM_I_Offset = DSReg(0x248, 12, 11, 1, 0, "writeonly", Regs_Arm9.data);
    MemControl3_VRAM_I_Enable = DSReg(0x248, 15, 15, 1, 0, "writeonly", Regs_Arm9.data);
    ...
    DIV_NUMER_Low = DSReg(0x290, 31, 0, 1, 0, "readwrite", Regs_Arm9.data);
    DIV_NUMER_High = DSReg(0x294, 31, 0, 1, 0, "readwrite", Regs_Arm9.data);
    DIV_DENOM_Low = DSReg(0x298, 31, 0, 1, 0, "readwrite", Regs_Arm9.data);
    DIV_DENOM_High = DSReg(0x29C, 31, 0, 1, 0, "readwrite", Regs_Arm9.data);
    DIV_RESULT_Low = DSReg(0x2A0, 31, 0, 1, 0, "readonly", Regs_Arm9.data);
    DIV_RESULT_High = DSReg(0x2A4, 31, 0, 1, 0, "readonly", Regs_Arm9.data);
    DIVREM_RESULT_Low = DSReg(0x2A8, 31, 0, 1, 0, "readonly", Regs_Arm9.data);
    DIVREM_RESULT_High = DSReg(0x2AC, 31, 0, 1, 0, "readonly", Regs_Arm9.data);
    ...
    SQRT_PARAM_Low = DSReg(0x2B8, 31, 0, 1, 0, "readwrite", Regs_Arm9.data);
    SQRT_PARAM_High = DSReg(0x2BC, 31, 0, 1, 0, "readwrite", Regs_Arm9.data);
