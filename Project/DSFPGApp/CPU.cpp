...
#endif
			if (!InstrCache.inCache(cachetest_addr, true))
			{
				if (newticks <= 0x34)
				{
					newticks = 0x34;
	...
	if (execute)
	{
		...
		case 0: // (27..25) = 000 => alu commands?
			...
			default:
				...
				else if (isArm9 && (((asmcmd >> 20) & 0xFF) == 0x12) && (opcode_low & 0xB) == 0xA)
				{
				...
				else if (isArm9 && (((asmcmd >> 20) & 0xFF) == 0x12) && (opcode_low & 0xB) == 0x8)
				{
