...
RegSect_system7::RegSect_system7()
{
    ...
    IF_LCD_V_Blank = DSReg(0x210, 0, 0, 1, 0, "readwrite", Regs_Arm7.data);
    IF_LCD_H_Blank = DSReg(0x210, 1, 1, 1, 0, "readwrite", Regs_Arm7.data);
    IF_LCD_V_Counter_Match = DSReg(0x210, 2, 2, 1, 0, "readwrite", Regs_Arm7.data);
    IF_Timer_0 = DSReg(0x210, 3, 3, 1, 0, "readwrite", Regs_Arm7.data);
    IF_Timer_1 = DSReg(0x210, 4, 4, 1, 0, "readwrite", Regs_Arm7.data);
    IF_Timer_2 = DSReg(0x210, 5, 5, 1, 0, "readwrite", Regs_Arm7.data);
    IF_Timer_3 = DSReg(0x210, 6, 6, 1, 0, "readwrite", Regs_Arm7.data);
    IF_SIO_RCNT_RTC = DSReg(0x210, 7, 7, 1, 0, "readwrite", Regs_Arm7.data);
    IF_DMA_0 = DSReg(0x210, 8, 8, 1, 0, "readwrite", Regs_Arm7.data);
    IF_DMA_1 = DSReg(0x210, 9, 9, 1, 0, "readwrite", Regs_Arm7.data);
    IF_DMA_2 = DSReg(0x210, 10, 10, 1, 0, "readwrite", Regs_Arm7.data);
    IF_DMA_3 = DSReg(0x210, 11, 11, 1, 0, "readwrite", Regs_Arm7.data);
    IF_Keypad = DSReg(0x210, 12, 12, 1, 0, "readwrite", Regs_Arm7.data);
    IF_GBA_Slot_external_IRQ = DSReg(0x210, 13, 13, 1, 0, "readwrite", Regs_Arm7.data);
    IF_IPC_Sync = DSReg(0x210, 16, 16, 1, 0, "readwrite", Regs_Arm7.data);
    IF_IPC_Send_FIFO_Empty = DSReg(0x210, 17, 17, 1, 0, "readwrite", Regs_Arm7.data);
    IF_IPC_Recv_FIFO_Not_Empty = DSReg(0x210, 18, 18, 1, 0, "readwrite", Regs_Arm7.data);
    IF_NDS_Slot_Transfer_Complete = DSReg(0x210, 19, 19, 1, 0, "readwrite", Regs_Arm7.data);
    IF_NDS_Slot_IREQ_MC = DSReg(0x210, 20, 20, 1, 0, "readwrite", Regs_Arm7.data);
    IF_Screens_unfolding = DSReg(0x210, 22, 22, 1, 0, "writeonly", Regs_Arm7.data);
    IF_SPI_bus = DSReg(0x210, 23, 23, 1, 0, "writeonly", Regs_Arm7.data);
    IF_Wifi = DSReg(0x210, 24, 24, 1, 0, "writeonly", Regs_Arm7.data);
}
...
void REGS_Arm7::reset()
{
    ...
    // IF at 0x214 = 0x0;
    rwmask[532] = (byte)(0x0 & 0xFF);
    rwmask[533] = (byte)((0x0 >> 8) & 0xFF);
    rwmask[534] = (byte)((0x0 >> 16) & 0xFF);
    rwmask[535] = (byte)((0x0 >> 24) & 0xFF);
