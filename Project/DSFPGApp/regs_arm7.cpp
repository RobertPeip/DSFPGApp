...
{
    SOUNDREGS = DSReg(0x400, 31, 0, 64, 0, "readwrite", Regs_Arm7.data);
    SOUNDCNT = DSReg(0x500, 15, 0, 1, 0, "writeonly", Regs_Arm7.data);
    SOUNDCNT_Master_Volume = DSReg(0x500, 6, 0, 1, 0, "readwrite", Regs_Arm7.data);
    SOUNDCNT_Left_Output_from = DSReg(0x500, 9, 8, 1, 0, "readwrite", Regs_Arm7.data);
    SOUNDCNT_Right_Output_from = DSReg(0x500, 11, 10, 1, 0, "readwrite", Regs_Arm7.data);
    SOUNDCNT_Output_Ch1_to_Mixer = DSReg(0x500, 12, 12, 1, 0, "readwrite", Regs_Arm7.data);
    SOUNDCNT_Output_Ch3_to_Mixer = DSReg(0x500, 13, 13, 1, 0, "readwrite", Regs_Arm7.data);
    SOUNDCNT_Master_Enable = DSReg(0x500, 15, 15, 1, 0, "readwrite", Regs_Arm7.data);
    SOUNDBIAS = DSReg(0x504, 9, 0, 1, 0x0200, "readwrite", Regs_Arm7.data);
    SOUNDCAP = DSReg(0x508, 15, 0, 1, 0, "writeonly", Regs_Arm7.data);
    SOUNDCAP0_Control = DSReg(0x508, 0, 0, 1, 0, "readwrite", Regs_Arm7.data);
    SOUNDCAP0_Capture_Source = DSReg(0x508, 1, 1, 1, 0, "readwrite", Regs_Arm7.data);
    SOUNDCAP0_Capture_Repeat = DSReg(0x508, 2, 2, 1, 0, "readwrite", Regs_Arm7.data);
    SOUNDCAP0_Capture_Format = DSReg(0x508, 3, 3, 1, 0, "readwrite", Regs_Arm7.data);
    SOUNDCAP0_Capture_Start_Status = DSReg(0x508, 7, 7, 1, 0, "readwrite", Regs_Arm7.data);
    SOUNDCAP1_Control = DSReg(0x508, 8, 8, 1, 0, "readwrite", Regs_Arm7.data);
    SOUNDCAP1_Capture_Source = DSReg(0x508, 9, 9, 1, 0, "readwrite", Regs_Arm7.data);
    SOUNDCAP1_Capture_Repeat = DSReg(0x508, 10, 10, 1, 0, "readwrite", Regs_Arm7.data);
    SOUNDCAP1_Capture_Format = DSReg(0x508, 11, 11, 1, 0, "readwrite", Regs_Arm7.data);
    SOUNDCAP1_Capture_Start_Status = DSReg(0x508, 15, 15, 1, 0, "readwrite", Regs_Arm7.data);
    SNDCAP0DAD = DSReg(0x510, 26, 0, 1, 0, "readwrite", Regs_Arm7.data);
    SNDCAP0LEN = DSReg(0x510, 15, 0, 1, 0, "readwrite", Regs_Arm7.data);
    SNDCAP1DAD = DSReg(0x518, 26, 0, 1, 0, "readwrite", Regs_Arm7.data);
    SNDCAP1LEN = DSReg(0x51C, 15, 0, 1, 0, "readwrite", Regs_Arm7.data);
}
